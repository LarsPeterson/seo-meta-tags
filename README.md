...
<head>
	...
	<meta name="application-name" content="Lars Peterson">
	...
	<!-- Apple -->
	<meta name="apple-mobile-web-app-title" content="Lars Peterson">

	<link rel="apple-touch-icon" sizes="180x180" href="/assets/favicons/apple-touch-icon.png">
	<link rel="mask-icon" href="/assets/favicons/safari-pinned-tab.svg" color="grey">
